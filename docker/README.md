...
`compose.yaml` fournit PostgreSQL 17, un service ponctuel de migrations, Django
...
5. Créer le premier administrateur sur une base neuve :
   ...
   ```sh
   docker compose --env-file .env.docker exec backend python /app/deployment/bootstrap_admin.py
   ```
