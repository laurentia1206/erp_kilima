...
const Systeme=(()=>{
  ...
  async function ouvrir(){
    ...
    <div class="sys-links"><button class="btn" data-section="agents">Créer / gérer les comptes</button><button class="btn" data-section="roles">Rôles et héritage</button><button class="btn" id="sys-audit">Journal de sécurité</button><button class="btn" id="sys-password">Mon mot de passe</button></div>
