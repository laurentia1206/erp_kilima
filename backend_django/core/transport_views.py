...
from .models import (Avance, Camion, Chauffeur, Commande, ContratTransport, Course,
                     CourseRequisition, Devis, Engin, Facture, InterventionCamion,
                     Justification, LigneFacture, OrdreDepense, Parametre, Requisition,
                     Role, Societe, TarifContrat, Tiers)
...
def terminer_intervention(request, intervention_id):
    ...
    if i.plan_id:
        from . import engins_lib, maintenance_lib
        from .models import PlanEntretien
