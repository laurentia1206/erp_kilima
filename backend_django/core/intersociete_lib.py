...
from . import comptabilite, services
from .models import (Article, Commande, Course, Devis, Facture, LigneCommande,
                     LigneDevis, LigneFacture, LigneReceptionInter, MouvementStock,
                     ReceptionInter, Societe, Tiers)
