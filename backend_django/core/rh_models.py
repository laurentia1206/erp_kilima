...
class RHDette(RHBase):
    ...
    avance_source = models.OneToOneField('core.Avance', null=True, blank=True, on_delete=models.PROTECT)
...
class RHPaiement(RHBase):
    ...
    mouvement_id = models.UUIDField(null=True,blank=True)
    compte_bancaire = models.ForeignKey('core.CompteBancaire',null=True,blank=True,on_delete=models.PROTECT)
