...
def login(request):
    ...
    ok = bool(user) and bcrypt.checkpw(password.encode("utf-8")[:72],
    ...
    return Response({"access_token": creer_token(user.id), "token_type": "bearer"})
