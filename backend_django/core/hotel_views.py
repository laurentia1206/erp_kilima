...
from .models import (Chambre, Facture, LigneFacture, LigneSejour, Sejour,
                     Societe, Tiers)
from .views import _societe_param
from .catalogue import normaliser, verifier_doublon, verrouiller_catalogue, tiers_visibles
