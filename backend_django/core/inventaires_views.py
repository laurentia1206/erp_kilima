...
from .models import Article, Depot, Societe, StockDepot, InventaireDepot, LigneInventaireDepot
from . import stock_lib, services, comptabilite, intersociete_lib
from .depots_views import ROLES, _inventaire_dict
...
@api_view(['POST'])
@transaction.atomic
def decision(request, inventaire_id):
