...
from .catalogue import tiers_disponible
...
from .models import (Article, Caisse, Commande, Course, Devis, Facture, LigneDevis,
                     LigneFacture, LigneLivraison, LigneEcriture, Livraison,
                     MouvementCaisse, MouvementStock, PaiementFacture, Societe, Tiers)
