...
from . import comptabilite, engins_lib, intersociete_lib, services
from .auth import assert_acces_societe, assert_role
from .erreurs import refus
from .models import (ArretPrestationEngin, Engin, Facture, InterventionCamion,
                     LigneFacture, Parametre, PrestationEngin, Societe, Tiers)
...
@api_view(["PATCH"])
def maj_engin(request, engin_id):
...
def maj_prestation(request, prestation_id):
