...
from .models import (RHPaieMois, RHBulletin, RHRetenue, RHPaiement, RHContrat, RHDette, RHSimulation,
    RHPointage, Tiers, Caisse, SessionCaisse, MouvementCaisse, Societe, CompteBancaire, LigneEcriture)
from .rh_views import contexte, ident, texte, choix, argent, sauver, simple, DOSSIERS, jour
from .rh_finances import CAISSE, tiers_agent
from .rh_calculs import arrondi, entier
from .rh_mensuel_calculs import calculer
from .tva_views import periode_mensuelle
from . import services, comptabilite
...
def payer(request,bulletin_id):
    ...
    if mode=='caisse':
        ...
        from .caisse_views import _soldes
