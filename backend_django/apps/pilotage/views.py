...
class FileTravail:
    ...
    def operations(self):
        ...
        from apps.transport.views import ROLES as TRANSPORT, ROLES_MAINT, _role_validation
        from apps.hotel.views import ROLES as HOTEL
        from apps.maintenance.documents_views import ROLES as DOCUMENTS, JOURS_ALERTE
        from apps.commercial.ventes_views import _facturable
