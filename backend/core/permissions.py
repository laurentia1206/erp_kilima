...
class PermissionsModules(BasePermission):
    ...
    def has_permission(self,request,view):
        if getattr(request.user,'id',None):
            ...
            if change and not (view.__class__.__module__=='core.views' and view.__class__.__name__ in ('MeView','SocieteViewSet','LogoutView')) and not (view.__class__.__module__=='core.admin_views' and getattr(view,'action',None)=='mot_de_passe'):
        ...
        if est_super_admin(request.user):
            ...
            allowed=(source=='core.admin_views' or source=='core.audit_views'
                or source=='core.views' and name in ('MeView','SocieteViewSet','LogoutView')
